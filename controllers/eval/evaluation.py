...
# 出力先フォルダパス
output_dir_path = "eval/result_2021_12_17_2022_01_14/"
# シミュレーション結果フォルダ
out_simulation_result_dir = "out/result_2021_12_17_2022_01_14/"
# 吸い込み評価用ファイルパス
base_file_inhalt_path = "data/config_data/all/base/all_bems_data5.csv"

# 温度取りデータ評価用ファイル
observe_file_path = "data/config_data/observe/all_observe.csv"
# 温度取りデータ位置座標ファイルパス
